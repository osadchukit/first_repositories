...
// // // const transaktionDeposit = createTransaction(200, TypesTransaction.DEPOSIT);
// // // console.log(transaktionDeposit);

// // account.deposit(200);
// // account.withdraw(1102);
// // account.deposit(2000);
// // account.withdraw(100);
// // console.log(account.getBalance());
// // console.log(account.getTransactionDetails(1));
// // console.log(account.getTransactionTotal(TypesTransaction.DEPOSIT));
// // console.log(account.getTransactionTotal(TypesTransaction.WITHDRAW));
...
//     this.balance += amount;
//     const newTransactions = this.createTransaction(amount, Types.DEPOSIT);
...
// console.log(account.getBalance());
// console.log(account.getTransactionDetails(Types.DEPOSIT));
