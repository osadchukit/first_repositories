...
// const getModels = cars => cars.map(car => car.make)
...
//     return cars.map(modelcar => {
//         return {
//           ...car,
//           price: car.price - (car.price * discount),
//         };
//         // console.log(cars.price - (cars.price * discount));
//     });
// };
...
//     const sortByAscendingAmount2 = [...cars].sort(
//       (a, b) => a.amount - b.amount
//     );
//     return sortByAscendingAmount2
// };
...
//   if (order === 'asc') {
//     sortCars.sort((a, b) => (a.model > b.model ? 1 : -1));
//   }
//   if (order === 'desc') {
//     sortCars.sort((a, b) => (a.model < b.model ? 1 : -1));
//   }
